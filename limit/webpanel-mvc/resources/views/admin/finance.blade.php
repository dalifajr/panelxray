...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0 text-white">Dashboard Keuangan</h2>
        <div>
        ...
        <div class="col-md-5 mb-4">
            <div class="card border-0 shadow-sm lift-hover h-100">
                <div class="card-header bg-dark text-white border-bottom border-secondary">
                    <h5 class="mb-0"><i class="fas fa-crown text-warning me-2"></i>Pelanggan Royal (Top 10)</h5>
                </div>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item bg-dark text-white border-secondary d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div class="fw-bold">{{ $royal->name }}</div>
                        ...
                        @empty
                        <li class="list-group-item bg-dark text-white border-secondary text-center text-muted py-4">Belum ada pelanggan.</li>
                        @endforelse
                    </ul>
                </div>
            </div>
        ...
        <div class="col-md-7 mb-4">
            <div class="card border-0 shadow-sm lift-hover h-100">
                <div class="card-header bg-dark text-white border-bottom border-secondary d-flex justify-content-between align-items-center">
                    <h5 class="mb-0"><i class="fas fa-history text-info me-2"></i>Transaksi Terkini</h5>
                </div>
                        ...
                        <table class="table table-dark table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-3 fw-bold">{{ $trx->user->username ?? 'Unknown' }}</td>
                                    <td class="px-3">
                                        @if($trx->type == 'topup')
                                    ...
                                    <td class="px-3 fw-bold">Rp {{ number_format($trx->total_amount, 0, ',', '.') }}</td>
                                    <td class="px-3">
