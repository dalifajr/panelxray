...
# // USERNAME IZIN IPP
rm -f /usr/bin/user
username=$(curl -sS https://raw.githubusercontent.com/dalifajr/panelxray/main/kunci | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user

# // VALIDITY
rm -f /usr/bin/e
valid=$(curl -sS https://raw.githubusercontent.com/dalifajr/panelxray/main/kunci | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl -sS https://raw.githubusercontent.com/dalifajr/panelxray/main/kunci | grep $MYIP | awk '{print $3}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
